(function(k) {
    ...
    d.prototype.getLightningOutParamsObj = function() {
        ...
        embedded_svc.config && embedded_svc.config.additionalSettings && embedded_svc.config.additionalSettings.labelsLanguage ? a = {
            ...
            } : embedded_svc.settings.language && "" !== embedded_svc.settings.language.trim() &&
            (a = {
    ...
    d.prototype.instantiateLightningOutApplication = function(a) {
        if ("function" !== typeof Promise) this.loadScriptFromDirectory("common", "promisepolyfill", function() {
            ...
            try {
                ...
                var f = a && a.oauthToken ?
                    a.oauthToken : embedded_svc.settings.oauthToken;
    ...
    d.prototype.appendHelpButton = function(a) {
        ...
        b.innerHTML = '<div class="helpButton"' + c + '><button class="helpButtonEnabled uiButton" href="javascript:void(0)"><span class="embeddedServiceIcon" aria-hidden="true" data-icon="&#59648;"></span><span class="helpButtonLabel" id="helpButtonSpan" aria-live="polite" aria-atomic="true"><span class="assistiveText">' +
    ...
    d.prototype.appendIFrame = function() {
        ...
        window.addEventListener("beforeunload", function(c) {
            ...
            if (this.isMasterAndHasSlaves)
                ...
                else return (c || window.event).returnValue =
    ...
    d.prototype.init =
        function(a, b, c, e, f, h) {
            ...
            embedded_svc.utils ?
                this.finishInit() : this.loadScriptFromDirectory("utils", "common", this.finishInit.bind(this))
        };
    d.prototype.finishInit = function() {
        ...
        if (!embedded_svc.utils.fireEvent("validateInit", function(a) {
            ...
            this.settings.appendHelpButton &&
                this.loadCSS();
    ...
    d.prototype.onFeatureScriptsLoaded = function() {
        "complete" === document.readyState ?
            setTimeout(this.prepareDOM.bind(this), 1) : document.addEventListener ? (document.addEventListener("DOMContentLoaded", this.prepareDOM.bind(this), !1), window.addEventListener("load", this.prepareDOM.bind(this), !1)) : window.attachEvent ? window.attachEvent("onload", this.prepareDOM.bind(this)) : this.log("No available event model. Exiting.")
    };
    ...
    d.prototype.addMessageHandler = function(a, b) {
        this.messageHandlers[a] ? (this.warning("Replacing an existing handler for message type " + a), this.messageHandlers[a].pop()) : this.messageHandlers[a] = [];
        this.messageHandlers[a].push(b)
    };
    d.prototype.clearMessageHandlers = function() {
        Object.keys(this.messageHandlers).forEach(function(a) {
    ...
    d.prototype.loadScriptFromDirectory = function(a, b, c, e) {
        ...
        f.type = "text/javascript";
        f.src = [h, "embeddedservice", e ? void 0 : this.settings.releaseVersion, a, b + (this.settings.devMode ? "" : ".min") + ".js"].filter(function(g) {
            return !!g
        }).join("/");
        c && (f.onload = c);
        document.body.appendChild(f)
    };
    d.prototype.loadFeatures =
        function(a) {
    ...
    d.prototype.setDefaultShowIcon = function(a, b) {
        this.settings.entryFeature === a && void 0 === this.settings.showIcon && (this.settings.showIcon =
            b)
    };
    ...
    d.prototype.getLinkActionData = function() {
        window.location.search.replace(/([a-zA-Z0-9._]+)=([^&\s]+)/g, function(a, b, c) {
            a = b.toLowerCase();
            0 === a.indexOf("snapins.") && (a = a.replace("snapins.", ""), "action" ===
                a ? (c = c.split("."), 2 === c.length && (this.settings.linkAction.feature = c[0], this.settings.linkAction.name = c[1])) : this.settings.linkActionParameters[a.toLowerCase()] = c)
        }.bind(this))
    };
    d.prototype.requireAuthentication = function() {
        ...
        if (!this.settings.useCustomAuthentication) {
            ...
            b.sheet.insertRule(".sfid-logout { display: none; }",
                0);
